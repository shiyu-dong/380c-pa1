...
#ls examples/good.*.bali | awk '{print "java -jar BaliCompiler.jar ./" $1 " " $1 ".sam; echo " $1 "; echo "}' | sh
#ls tests/*.bali | awk '{print "java -jar BaliCompiler.jar ./" $1 " " $1 ".sam; echo " $1 "; echo "}' | sh
